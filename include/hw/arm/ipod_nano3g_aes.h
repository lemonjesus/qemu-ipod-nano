#ifndef HW_ARM_IPOD_NANO3G_AES_H
#define HW_ARM_IPOD_NANO3G_AES_H
...
#define TYPE_IPOD_NANO3G_AES                "ipodnano3g.aes"
OBJECT_DECLARE_SIMPLE_TYPE(S5L8702AESState, IPOD_NANO3G_AES)

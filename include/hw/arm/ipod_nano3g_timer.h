#ifndef IPOD_NANO3G_TIMER_H
#define IPOD_NANO3G_TIMER_H
...
#define TYPE_IPOD_NANO3G_TIMER                "ipodnano3g.timer"
OBJECT_DECLARE_SIMPLE_TYPE(IPodNano3GTimerState, IPOD_NANO3G_TIMER)

#define TIMER_IRQSTAT 0x10000
#define TIMER_IRQLATCH 0xF8
#define TIMER_TICKSHIGH 0x80
#define TIMER_TICKSLOW 0xB4
...
typedef struct IPodNano3GTimerState
{
    SysBusDevice busdev;
    MemoryRegion iomem;
    uint32_t    ticks_high;

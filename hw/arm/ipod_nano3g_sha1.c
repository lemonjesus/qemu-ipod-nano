...
static void flush_hw_buffer(S5L8702SHA1State *s) {
...
static void sha1_reset(S5L8702SHA1State *s)
{
	s->config = 0;
	s->memory_start = 0;
	s->memory_mode = 0;
...
static uint64_t S5L8702_sha1_read(void *opaque, hwaddr offset, unsigned size)
{
	S5L8702SHA1State *s = (S5L8702SHA1State *)opaque;
...
static void S5L8702_sha1_write(void *opaque, hwaddr offset, uint64_t value, unsigned size)
{
    S5L8702SHA1State *s = (S5L8702SHA1State *)opaque;
...
static const MemoryRegionOps sha1_ops = {
    .read = S5L8702_sha1_read,
    .write = S5L8702_sha1_write,
    .endianness = DEVICE_NATIVE_ENDIAN,
};

static void S5L8702_sha1_init(Object *obj)
{
    SysBusDevice *sbd = SYS_BUS_DEVICE(obj);
    DeviceState *dev = DEVICE(sbd);
    S5L8702SHA1State *s = IPOD_NANO3G_SHA1(dev);
...
static void S5L8702_sha1_class_init(ObjectClass *klass, void *data)
{

}

static const TypeInfo ipod_nano3g_sha1_info = {
    .name          = TYPE_IPOD_NANO3G_SHA1,
    .parent        = TYPE_SYS_BUS_DEVICE,
    .instance_size = sizeof(S5L8702SHA1State),
    .instance_init = S5L8702_sha1_init,
    .class_init    = S5L8702_sha1_class_init,
};

static void ipod_nano3g_machine_types(void)
{
    type_register_static(&ipod_nano3g_sha1_info);
}
